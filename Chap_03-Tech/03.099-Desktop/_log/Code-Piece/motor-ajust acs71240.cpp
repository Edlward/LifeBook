...
namespace outputInternal
{
    ...
    int32_t MotorImp::si32UpdateIncrementalPiController()
    {
        ...
        const uint16_t cui16RawMotorCurrentInAdQuanta1 = ui16GetCalibrationSampleValue( motorCurrent1Adc->ui16GetRawAdValue() );
        const uint16_t cui16RawMotorCurrentInAdQuanta2 = ui16GetCalibrationSampleValue( motorCurrent2Adc->ui16GetRawAdValue() );
